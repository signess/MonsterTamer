...
public class DialogueGraphView : GraphView
{
    ...
    public void AddPropertyToBlackBoard(ExposedProperty exposedProperty, bool refreshing = false)
    {
        ...
        container.Add(new Button(() => { RemovePropertyFromBlackboard(localPropertyName); }) { text = "X" });
    ...
    private void RemovePropertyFromBlackboard(string propertyName)
    {
        ...
        foreach (var exposedProperty in ExposedProperties.ToList())
        {
